...
from .lv_validation import lv_font, lv_gradient
...
STYLE_PROPS = {
    ...
    "transform_angle": cv.invalid("Use transform_rotation instead"),
    ...
    "transform_radial": lvalid.lv_angle,
    "transform_rotation": lvalid.lv_angle,
    "transform_scale_x": lvalid.zoom,
    "transform_scale_y": lvalid.zoom,
    "transform_skew_x": lvalid.angle,
    "transform_skew_y": lvalid.angle,
    "transform_width": lvalid.pixels_or_percent,
    "transform_zoom": cv.invalid("Use transform_scale_x and transform_scale_y instead"),
...
def collect_states(config):
    ...
    :return:
    """
    states = {"default": collect_props(config)}
